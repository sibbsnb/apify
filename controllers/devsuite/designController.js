routingExample.controller('DesignCtrl', ['$scope', '$location',
    function($scope, $location, $modal, $log) {
        routingExample.controller('NavCtrl', ['$scope', '$location',
            function($scope, $location) {
                $scope.breadcrumbs = [];
                $scope.menu = devSuiteMenuData;
            }
        ]);
        $scope.submenu = devSuiteSubMenuData;
        $scope.modalimgData;
...
routingExample.controller('DevsuiteDocCtrl', function($scope) {
    $scope.pdfUrl = '/resources/devsuite_design.pdf';
});
